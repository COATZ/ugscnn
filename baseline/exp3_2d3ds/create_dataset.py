...
path_dataset_new = "/media/cartizzu/DATA/LIN/2_CODE/4_SEGMENTATION/ugscnn/baseline/exp3_2d3ds/data2/"

for area in ["area_1","area_2","area_3","area_4","area_5a","area_5b","area_6"]:
    for feat in ["rgb","depth","semantic"]:
        path_dataset_local = os.path.join(path_dataset,str(area),"data",feat)
